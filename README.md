...
the headless editor session. The formal global-validation service remains future work.
...
- Reconcile reference labels/rules and implement the interactive editor UI.
